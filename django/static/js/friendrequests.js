...
function cancelFriendRequest(id, csrf) {
    ...
    $.ajax({
        type: "POST",
        dataType: "json",
        url: "/users/cancel_friend_request/",
        data: payload,
        timaout: 5000,
        success: function(data) {
...
function acceptFriendRequest(friend_request_id, container) {
    var url = "/users/accept_friend_request/" + friend_request_id
    $.ajax({
        type: "GET",
        dataType: "json",
        url: url,
...
function declineFriendRequest(friend_request_id, origin) {
    var url = `/users/decline_friend_request/${friend_request_id}`;
    $.ajax({
        type: "GET",
        dataType: "json",
        url: url,
...
function blockUnblock(id, action) {
    var url = `/users/blocking?user_id=${id}&action=${action}`
    $.ajax({
        type: "GET",
        dataType: "json",
        url: url,
...
function createCancelFriendRequestBtn(id, csrf) {
    ...
    btn.setAttribute("data-next-url", "/users/friend_request/");
    return btn;
}
